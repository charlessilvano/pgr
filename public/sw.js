const CACHE_NAME = "gerador-pgr-github-v1";
...
const APP_SHELL = [
  ...
  new URL("pgr-icon-192.png", self.registration.scope).toString(),
  new URL("pgr-icon-512.png", self.registration.scope).toString(),
];
