...
export const condoCatalog: CondoDefinition[] = [
  { id: "porto-rico", name: "Porto Rico Residencial", expectedTotal: 1, suggestedRoleIds: ["auxiliar-servicos-gerais"], fixedCounts: { "auxiliar-servicos-gerais": 1 } },
  ...
  { id: "wa-serv", name: "WA SERV LTDA", expectedTotal: 13, suggestedRoleIds: ["gerente", "agente-patrimonio", "supervisor-operacional", "auxiliar-servicos-gerais"], note: "O documento informa o total e os cargos, mas não apresenta a divisão das quantidades por cargo." },
  { id: "vila-toscana", name: "Condomínio Residencial Vila Toscana", expectedTotal: 1, suggestedRoleIds: ["zelador"], fixedCounts: { zelador: 1 } },
  { id: "san-marino", name: "Condomínio San Marino Residencial", expectedTotal: 5, suggestedRoleIds: ["supervisor-administrativo", "auxiliar-servicos-gerais"], note: "Confirmar a distribuição dos 5 trabalhadores entre os cargos indicados." },
  { id: "villa-lobos", name: "Condomínio Residencial Villa Lobos", expectedTotal: 1, suggestedRoleIds: ["supervisor-operacional"], fixedCounts: { "supervisor-operacional": 1 } },
  { id: "victoria-blue", name: "Condomínio Victoria Blue", expectedTotal: 1, suggestedRoleIds: ["auxiliar-servicos-gerais"], fixedCounts: { "auxiliar-servicos-gerais": 1 } },
  { id: "residencial-vitoria", name: "Condomínio Residencial Vitoria", expectedTotal: 1, suggestedRoleIds: ["zelador"], fixedCounts: { zelador: 1 } },
  { id: "dinamizza-gestao", name: "Dinamizza Gestão e Administração de Condomínios LTDA - ME", expectedTotal: 12, suggestedRoleIds: ["gerente-administrativo", "gerente-operacional", "coordenador-administrativo", "coordenador-operacional", "supervisor-administrativo", "supervisor-operacional", "assistente-administrativo", "assistente-dp", "assistente-operacional"], note: "A base descreve a equipe como administrativa e operacional; confirmar cargos e quantidades." },
  { id: "henri-matisse", name: "Condomínio Residencial Henri Matisse", expectedTotal: 7, suggestedRoleIds: ["porteiro", "zelador", "gerente-predial"], note: "Confirmar a distribuição dos 7 trabalhadores entre os três cargos." },
  { id: "helena-chaves", name: "Condomínio Edifício Helena Chaves", expectedTotal: 5, suggestedRoleIds: ["porteiro", "zelador"], note: "Confirmar a distribuição dos 5 trabalhadores entre portaria e zeladoria." },
  { id: "barra-grande", name: "Condomínio Barra Grande Exclusive Residence", expectedTotal: 7, suggestedRoleIds: ["vigia", "servicos-gerais", "encarregado", "gerente"], note: "Confirmar a distribuição dos 7 trabalhadores entre os cargos indicados." },
  { id: "praias-atlantico", name: "Praias do Atlântico Condomínio Clube", expectedTotal: 7, suggestedRoleIds: ["auxiliar-servicos-gerais", "porteiro", "agente-limpeza", "zelador-edificio"], note: "Confirmar a distribuição dos 7 trabalhadores entre os cargos indicados." },
  { id: "palazzo-milano", name: "Residencial Palazzo de Milano", expectedTotal: 3, suggestedRoleIds: ["auxiliar-servicos-gerais", "zelador"], note: "Confirmar a distribuição dos 3 trabalhadores entre os cargos indicados." },
  { id: "massimo", name: "Condomínio Massimo Residencial", expectedTotal: 6, suggestedRoleIds: ["porteiro", "auxiliar-servicos-gerais"], note: "Confirmar a distribuição dos 6 trabalhadores entre portaria e limpeza." },
  { id: "dinamizza-servicos", name: "Dinamizza Serviços Terceirizados LTDA", expectedTotal: 66, suggestedRoleIds: roleCatalog.map((role) => role.id), note: "A própria referência registra divergência entre o total informado e a soma das funções. Validar integralmente com o RH." },
  { id: "victoria-ville", name: "Condomínio Residencial Victoria Ville", expectedTotal: 2, suggestedRoleIds: [], note: "A base contém dois registros de 1 trabalhador e recomenda verificar possível duplicidade e os cargos." },
  { id: "maria-leandra", name: "Condomínio Edifício Maria Leandra", expectedTotal: 6, suggestedRoleIds: ["porteiro", "auxiliar-servicos-gerais"], note: "Confirmar a distribuição dos 6 trabalhadores entre portaria e limpeza." },
  { id: "beira-rio", name: "Centro Médico Odontológico Beira Rio", expectedTotal: 6, suggestedRoleIds: ["auxiliar-servicos-gerais", "zelador", "porteiro"], note: "Confirmar a distribuição dos 6 trabalhadores entre os cargos indicados." },
